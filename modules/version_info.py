...
def commit_hash():
    try:
        return subprocess.check_output([git, "rev-parse", "HEAD"], shell=False, encoding="utf8").strip()  # noqa: S603
    except Exception:
        return "<none>"
...
def get_torch_info():
    ...
    from torch import backends, cuda, version
...
def initialize_cuda():
    ...
    if cuda.is_available():
        device = cuda.device("cuda")  # noqa: F841
