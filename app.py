...
def generate(
    prompt: str, negprompt: str, seed: int, randomize_seed: bool, profile: gr.OAuthProfile | None
) -> list[str | None]:
    ...
    actual_seed = (
        np.random.randint(0, 2147483647 + 1) if randomize_seed else seed
    )  # Use 2147483647 as MAX_SEED, +1 because randint is exclusive for the upper bound
...
if __name__ == "__main__":
    ...
    launch_kwargs["css_paths"] = ["style.css"]
    launch_kwargs["theme"] = "Surn/beeuty@==0.5.25"
